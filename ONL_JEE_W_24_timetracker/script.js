//const apikey = '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';
 const apikey="33573bd3-b2bf-4bdf-8b00-e92d34fef629"
...
function formatTime(timeSpent){
    ...
    let minutes;
    let  timeFormatted= "";
    timeInHours = Math.floor(timeSpent/60);
    minutes = timeSpent % 60;
    if(timeSpent % 60 !==0){

        timeFormatted = timeInHours + "h";

    } else{
        timeFormatted = timeInHours + "h" + " " + minutes + "m";
    }
